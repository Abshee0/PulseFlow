              ...
              <div className="  dropdown-borad flex flex-col h-[70vh]  justify-between ">
                <div>
                  {boards.map((board, index) => (
                    <div
                      className={` flex items-baseline space-x-2 px-5 mr-8 rounded-r-full duration-500 ease-in-out py-4 cursor-pointer hover:bg-[#9ccec4] hover:text-[#316359] dark:hover:bg-[#f4f8f1] dark:hover:text-[#316359] dark:text-[#f4f8f1]  ${
                        board.isActive &&
                        " bg-[#9ccec4] rounded-r-full text-[#316359] mr-8 dark:bg-[#316359] dark:text-[#9ccec4] "
                      } `}
                      key={index}
                      onClick={() => {
